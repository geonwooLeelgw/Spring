...
<br>
<br>
    <form action="AddPointPro" id="Pay" method="POST" >
...
<input type="hidden" value="${finalMoney}" name="finalMoney"></li>
 ...
 <li class="w3-padding-16"><strong>결제금액:</strong><input type="button" value="입력" onclick="innerHTMLSelect()" class="btn" ><br> <br><span id="Send2"></li>
          <li class="w3-padding-16"><strong>포인트 충전결제방식을 골라주세요. </strong><input type="button" value="카드" onclick="innerHTMLCard()"class="btn" > <input type="button" value="계좌이체" onclick="innerHTMLSend()"class="btn" > <br><br>
          <span id="Send"></li>
