...
<br>
    ...
    <hr>
      ...
      <input class="w3-input w3-border" type="text" placeholder="ex)학익로" name="Start" id="start" required>
      <br>          
      <p><label><i class="fa fa-calendar-o"></i> 도착지</label></p>
      <input class="w3-input w3-border" type="text" placeholder="ex)학익로" name="end" id="end" required>         
      <br>
