...
<br>
      ...
      <article class="container">
        ...
        <form class="form-horizontal" action="DriverJoinPro" method="post" enctype="multipart/form-data" id=frm>
        ...
        <p class="help-block">ex)인천시 인천구 인천동 11-11</p>
         ...
         <div class="form-group">
          <label class="col-sm-3 control-label" for="inputPassword">라이센스 등록</label>
        <div class="col-sm-6">
          <input type="file"  name="file">
        <p class="help-block">사진을 첨부해주세요</p>
        </div>
        </div>
