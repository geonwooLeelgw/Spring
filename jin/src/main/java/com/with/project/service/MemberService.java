...
public class MemberService {
	...
	private final static String ACCOUNT = ("withtest6124@gmail.com");
	
	private final static String PASSWORD = ("ghshffnffn123");
	...
	// 유저 회원가입
	public ModelAndView UserJoin(MemberVO memberVO, HttpServletResponse response) {
		response.setContentType("text/html;charset=UTF-8");
		System.out.println("두번째 테스트:"+memberVO.getName());
		mav = new ModelAndView();
	...
	public void DriverCheck(String id, HttpServletResponse response) throws IOException {
		memberVO = new MemberVO();
		memberVO = memberDAO.DriverCheck(id);
		System.out.println("MEMBERVO 테스트"+memberVO);
		if(memberVO==null) {
			response.getWriter().print("1");
		}else {
			response.getWriter().print("0");
