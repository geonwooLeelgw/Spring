...
function goPopup(){
	...
	var pop = window.open("/mapTest/jusoPopup.jsp","pop","width=570,height=420, scrollbars=yes, resizable=yes"); 
...
<form name="form" id="form" method="post">
	...
	<input type="text" onClick="goPopup();" style="width:500px;" id="roadAddrPart1" name="roadAddrPart1"/>
	<div id="list"></div>
	<div id="callBackDiv">
		<table>
