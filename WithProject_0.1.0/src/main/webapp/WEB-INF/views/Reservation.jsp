    ...
    <form action="CreateRealRoom?roomId=${Room.roomId}" method="post">
      <div class="w3-half w3-margin-bottom" style="margin-left:25%;" >
        <ul class="w3-ul w3-center w3-card w3-hover-shadow">
          <li class="w3-dark-grey w3-xlarge w3-padding-32">예약 Room 입니다.</li>
          ...
          <li class="w3-padding-16"><strong>성별 옵션:</strong> ${Room.opGender }
          <br>
<%int num = 0; %>
...
<li class="w3-padding-16"><strong>예약 날짜 / 시간 :</strong> ${Room.dayDay } / ${Room.times }<br>
...
기사 ID : <a href="DriverInfo?Id=${Room.driverId}">${Room.driverId}</a><br>
        ...
        <strong>결제 미완료 </strong>    
             ...
             <input type="button" class="w3-button w3-white w3-padding-large w3-hover-black" onclick="location.href='Rpay?finalMoney=${Room.finalMoney}&roomId=${Room.roomId}'" value="결제">
             </c:if>
          <c:if test="${pay.okCash == '1'}">
동승중
<input type="button" class="w3-button w3-white w3-padding-large w3-hover-black" onclick="location.href='payCancel2?roomId=${Room.roomId}'" value="결제취소">
</c:if>

<c:if test="${pay.okCash == null}">
 <input type="button" class="w3-button w3-white w3-padding-large w3-hover-black" onclick="location.href='RoomOut2?roomId=${Room.roomId}'" value="방나가기">
 </c:if>
...
<input type="button" class="w3-button w3-white w3-padding-large w3-hover-black" onclick="location.href='ma2?rStart=${Room.rStart}&rEnd=${Room.rEnd}&roomId=${Room.roomId}&opGender=${Room.opGender}'" value="지도">
