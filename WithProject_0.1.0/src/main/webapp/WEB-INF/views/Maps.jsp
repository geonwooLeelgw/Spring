...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
 <link href="resources/boot/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="resources/boot/css/font-awesome.min.css" media="screen" title="no title">
    <link rel="stylesheet" href="resources/boot/css/style.css" media="screen" title="no title">
...
<br>
    ...
    <form name="form" id="form" method="post">
      ...
      <input class="w3-input w3-border" type="text" onClick="goPopup();" placeholder="ex)학익로" name="Start" id="roadAddrPart1" required>
      <br>          
      <p><label><i class="fa fa-calendar-o"></i> 도착지</label></p>
      <input class="w3-input w3-border" type="text" onClick="goPopup2();" placeholder="ex)학익로" name="end" id="roadAddrPart2" required>         
      <br>
      </form>
      <p><button class="w3-button w3-block w3-green w3-left-align" onclick="initTmap()" ><i class="fa fa-search w3-margin-right"></i> 경로검색 </button></p> <br>
       <p><button class="w3-button w3-block w3-green w3-left-align" onclick="location.href='ReStart'" ><i class="fa fa-search w3-margin-right"></i> 경로재검색 </button></p><br>
       <p><button class="w3-button w3-block w3-green w3-left-align" onclick="CreateRoom()" ><i class="fa fa-search w3-margin-right"></i> 방만들기 </button></p> <br>
