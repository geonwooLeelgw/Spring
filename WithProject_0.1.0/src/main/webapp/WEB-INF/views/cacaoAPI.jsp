...
<html>
    <head>
        ...
        <script>
        var hash = "a9b57f462ff062d1e178abd84062b7e2c077d0b15c6cab2f77c38b73bf03b3c9";
        var failUrl = "https://developers.kakao.com/payment/web/fail/13968e6e-07f4-4aeb-948c-3933c74298dc";
        var remainingSec = 889;
        var cancelUrl = "https://developers.kakao.com/payment/web/cancel/13968e6e-07f4-4aeb-948c-3933c74298dc";
    ...
    (function() {
        ...
        <div class="kakaopay_layer">
            <div class="inner_kakaopay">
                ...
                <div class="layer_body">
                    <p class="txt_step">결제요청 메시지 전송을 위해
                        <br> 카카오페이에 가입된
                        <br>휴대폰 번호와 생년월일 6자리를 입력해주세요.
                    </p>
                    <form id="userPost" method="post" action="/v1/a9b57f462ff062d1e178abd84062b7e2c077d0b15c6cab2f77c38b73bf03b3c9/uinfo" >
                        <fieldset>
