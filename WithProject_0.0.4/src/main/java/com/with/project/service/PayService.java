...
public class PayService {
	...
	//포인트충전하기
	public ModelAndView AddPointPro(String point, HttpSession session, String roomId, String finalMoney) {
		mav = new ModelAndView();
		String id = (String)session.getAttribute("id");
		MemberVO memberVO = payDAO.UserPoint(id);
	...
	public ModelAndView payCancel(HttpSession session, PayVO payVO) {
		...
		payDAO.UpdatePoint(memberVO);
		//RoomInfo
		mav.setViewName("redirect:RoomInfo?roomId="+roomId);
	...
	//예약 포인트 충전하기
	public ModelAndView AddPointPro2(String point, HttpSession session, String roomId, String finalMoney) {
		mav = new ModelAndView();
		String id = (String)session.getAttribute("id");
		MemberVO memberVO = payDAO.UserPoint(id);
		int Point = Integer.parseInt(point);
	...
	public ModelAndView payCancel2(HttpSession session, PayVO payVO) {
		...
		payDAO.UpdatePoint(memberVO);
		//RoomInfo
		mav.setViewName("redirect:RoomInfo2?roomId="+roomId);
		return mav;
	}
